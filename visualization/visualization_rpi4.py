            ...
            if response.status_code == 200:
                ...
                if data.get('success'):
                    ...
                    if download_and_replace_update(data['updateFile']):
                        ...
                        load_dotenv(dotenv_path='/home/RPI-4B/.env')
                        current_version = os.getenv('CURRENT_VERSION')
...
def download_and_replace_update(update_url):
    try:
        ...
        extract_path = "/home/RPI-4B/rasp-get/"  # Correct extraction path
...
def run_update_script():
    ...
    try:
        subprocess.Popen(
            ["bash", "/home/RPI-4B/rasp-get/update.sh"],
