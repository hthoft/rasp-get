...
# Setup kiosk mode
sudo printf "xset s off\nxset s noblank\nxset -dpms\nsetxkbmap -option terminate:ctrl_alt_bksp\nchromium-browser --disable-infobars --kiosk 'https://portal.maprova.dk/Visualisering/autoview.php?deviceTag=$rpiSerialNumber&deviceHash=8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92'" | sudo tee /etc/xdg/openbox/autostart
